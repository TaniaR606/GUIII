...
import java.awt.FlowLayout;
 ...
 private JList listaJListCopia; // lista en la que se van a copiar los nombres de los olores
...
listaJListCopia = new JList(); // crea lista para guardar nombres de colores copiados
 ...
 add( new JScrollPane( listaJListCopia ) ); // agrega lista con panel de esplazamiento
